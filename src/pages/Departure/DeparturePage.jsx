...
import { useDepartures } from '../../hooks/useFlight'
...
export default function DeparturePage() {
  ...
  const { data, isLoading, isError, dataUpdatedAt } = useDepartures(airportCode)
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <span style={{ fontWeight: '600', color: '#1a1f36' }}>도착지 공항</span>
        <input
          value={inputValue}
      ...
      <div style={{
        ...
        {isLoading ? <LoadingSpinner /> :
         ...
         <FlightTable flights={flights} type="departure" />}
      </div>
    </div>
  )
}